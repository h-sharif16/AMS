<%@ Page Title="" Language="C#" MasterPageFile="~/UserUI/Users.Master" AutoEventWireup="true" CodeBehind="WelcomeUI.aspx.cs" Inherits="AMS.UserUI.WelcomeUI" %>
        ...
        <div class="row bg-white has-shadow">
            ...
            <div class="col-xl-6 col-sm-6">
                <div class="item d-flex align-items-center">
                    ...
                    <div class="title">
                        <a href="PersonalSettings.aspx"> set up personal settings </a>
                        <div class="progress">
                            <div role="progressbar" style="height: 4px; width: 25%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-violet"></div>
                        </div>
                    </div>
            ...
            <div class="col-xl-6 col-sm-6">
                <div class="item d-flex align-items-center">
                    ...
                    <div class="title">
                        ...
                        <div class="progress">
                            <div role="progressbar" style="height: 4px; width: 25%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-red"></div>
                        </div>
                    </div>
                    <div class="number">
                        <strong>70</strong>
            ...
            <div class="col-xl-6 col-sm-6">
                <div class="item d-flex align-items-center">
                    ...
                    <div class="title">
                        ...
                        <div class="progress">
                            <div role="progressbar" style="height: 4px; width: 25%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-green"></div>
                        </div>
                    </div>
                    <div class="number">
                        <strong>44</strong>
            ...
            <div class="col-xl-6 col-sm-6">
                <div class="item d-flex align-items-center">
                    ...
                    <div class="title">
                        ...
                        <div class="progress">
                            <div role="progressbar" style="height: 4px; width: 25%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-orange"></div>
                        </div>
                    </div>
                    <div class="number">
                        <strong>35</strong>
            ...
            <div class="row bg-white has-shadow">
                <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                    ...
                    <div class="project-date">
                        <span class="hidden-sm-down">Today at 4:24 AM</span></div>
                </div>
                <div class="right-col col-lg-6 d-flex align-items-center">
                    <div class="time"><i class="fa fa-clock-o"></i>12:00 PM
                    </div>
                    <div class="comments"><i class="fa fa-comment-o"></i>20
                    </div>
                    <div class="project-progress">
                        <div class="progress">
                            <div role="progressbar" style="height: 6px; width: 45%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-red"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="project">
            <div class="row bg-white has-shadow">
                ...
                <div class="right-col col-lg-6 d-flex align-items-center">
                    ...
                    <div class="project-progress">
                        <div class="progress">
                            <div role="progressbar" style="height: 6px; width: 60%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-green"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="project">
            <div class="row bg-white has-shadow">
                ...
                <div class="right-col col-lg-6 d-flex align-items-center">
                    ...
                    <div class="project-progress">
                        <div class="progress">
                            <div role="progressbar" style="height: 6px; width: 50%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-violet"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="project">
            <div class="row bg-white has-shadow">
                ...
                <div class="right-col col-lg-6 d-flex align-items-center">
                    ...
                    <div class="project-progress">
                        <div class="progress">
                            <div role="progressbar" style="height: 6px; width: 50%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-orange"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="work-amount card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="chart text-center">
                            <div class="text">
                                <strong>90</strong><br><span>Hours</span></div>
        ...
        <div class="card-body no-padding">
            ...
            <div class="item d-flex justify-content-between">
                ...
                <div class="date text-right">
                    <strong>24</strong><span>May</span></div>
            </div>
            <!-- Item-->
            <div class="item d-flex justify-content-between">
                <div class="info d-flex">
                ...
                <div class="feed d-flex justify-content-between">
                    <div class="feed-body d-flex justify-content-between">
                        ...
                        <div class="content">
                            ...
                            <div class="CTAs">
                                <a href="#" class="btn btn-xs btn-secondary"><i class="fa fa-thumbs-up"> </i>Like</a><a href="#" class="btn btn-xs btn-secondary"><i class="fa fa-heart"> </i>Love </a>
                            </div>
                        </div>
                    </div>
                    <div class="date text-right">
            ...
            <div class="item">
                <div class="row">
                    <div class="col-4 date-holder text-right">
                        ...
                        <div class="date">
                            <span>6:00 am</span><span class="text-info">6 hours ago</span></div>
                    </div>
