...
namespace AMS.DAL
{
    public static class DbCommandExtension
    {
        ...
        {
            var objDbParameter = GetParameter();
        ...
        /// <param name="parameterSize"></param>
        public static void AddInParameter(this DbCommand objDbCommand, string parameterName, object parameterValue,
            DbType dbType, int parameterSize)
        {
            var objDbParameter = GetParameter();
            objDbParameter.ParameterName = spPrefix + parameterName;
            objDbParameter.Value = parameterValue;
        ...
        /// <param name="parameterValue"></param>
        /// <param name="parameterSize"></param>
        public static void AddOutParameter(this DbCommand objDbCommand, string parameterName, object parameterValue,
            int parameterSize)
        {
            var objDbParameter = GetParameter();
            objDbParameter.ParameterName = spPrefix + parameterName;
        ...
        public static void AddInOutParameter(this DbCommand objDbCommand, string parameterName, object parameterValue,
        ...
        /// <param name="parameterSize"></param>
        public static void AddInOutParameter(this DbCommand objDbCommand, string parameterName, object parameterValue,
            ParameterDirection parameterDirection, int parameterSize)
        {
            var objDbParameter = GetParameter();
            objDbParameter.ParameterName = spPrefix + parameterName;
            objDbParameter.Value = parameterValue;
        ...
        /// <param name="parameterSize"></param>
        public static void AddInOutParameter(this DbCommand objDbCommand, string parameterName, object parameterValue,
            ParameterDirection parameterDirection, DbType dbType, int parameterSize)
        {
            var objDbParameter = GetParameter();
            objDbParameter.ParameterName = spPrefix + parameterName;
            objDbParameter.Value = parameterValue;
